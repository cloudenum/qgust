...
> transformation $U$ generated by the exponentiated LQG area operator:
>
...
* A precise definition of the LQG area operator on causal-set-embedded graphs
* A proof that the modular Hamiltonian $H_{\text{mod}}$ equals the LQG area
